// www.themealdb.com/api/json/v1/1/filter.php?c=Vegetarian
...
async function showRandom(){
    ...
    let res = await fetch(`https://www.themealdb.com/api/json/v1/1/filter.php?c=Vegetarian`);
    ...
    data.meals.forEach(({strMeal, strMealThumb})=>{
        ...
        imgMeal.style.height="40%"; // 200px
        imgMeal.style.width = "100%";

        nameMeal.style.height = "9%" // 50px
        nameMeal.style.margin = "0px"
        
        singleProductDiv.append(imgMeal,nameMeal);
